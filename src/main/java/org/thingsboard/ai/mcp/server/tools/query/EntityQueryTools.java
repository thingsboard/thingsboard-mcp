...
public class EntityQueryTools implements McpTools {
    ...
    // Entity Data Query:
    @Tool(description = "Find Entity Data for single entity by its id. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    public String findEntityDataBySingleEntityFilter(
            ...
            @ToolParam(required = false, description = "To filter results of the entity filter by complex criteria against main entity fields (name, label, type, etc.), attributes and telemetry") @Valid List<KeyFilter> keyFilters,
            @ToolParam(required = false, description = "List of entities field to fetch for each entity") @Valid List<EntityKey> entityFields,
            @ToolParam(required = false, description = "List of latest attribute/telemetry to fetch for each entity") @Valid List<EntityKey> latestValues,
            @ToolParam(description = PAGE_SIZE_DESCRIPTION) @Positive Integer pageSize,
            @ToolParam(description = PAGE_NUMBER_DESCRIPTION) @PositiveOrZero Integer page,
        ...
        SingleEntityFilter filter = JacksonUtil.fromString(singleEntityFilter, SingleEntityFilter.class);
    ...
    @Tool(description = "Find Entity Data for entities of the same type using the entity group type and id. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for entities of the same type using their ids. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for entities of the same type using the **'starts with'** expression over entity name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for entities based on their type (CUSTOMER, USER, DASHBOARD, ASSET, DEVICE, etc). Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @PeOnly
    @Tool(description = "Find Entity Data for multiple groups of the same type using specified ids. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @PeOnly
    @Tool(description = "Find Entity Data for entity groups based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide()." + PE_ONLY_AVAILABLE)
    ...
    @PeOnly
    @Tool(description = "Find Entity Data for entities that belong to group based on the entity type and the group name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide()." + PE_ONLY_AVAILABLE)
    ...
    @Tool(description = "Find Entity Data for owner (Tenant or Customer) of the specified entity. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for assets based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for devices based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for edges based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    public String findEntityDataByEdgeTypeFilter(
            @ToolParam(description = EDGE_TYPE) @Valid @NotNull EdgeTypeFilter deviceTypeFilter,
            @ToolParam(required = false, description = "To filter results of the entity filter by complex criteria against main entity fields (name, label, type, etc.), attributes and telemetry") @Valid List<KeyFilter> keyFilters,
            @ToolParam(required = false, description = "List of entities field to fetch for each entity") @Valid List<EntityKey> entityFields,
            @ToolParam(required = false, description = "List of latest attribute/telemetry to fetch for each entity") @Valid List<EntityKey> latestValues,
            @ToolParam(description = PAGE_SIZE_DESCRIPTION) @Positive Integer pageSize,
    ...
    @Tool(description = "Find Entity Data for entity views based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for api usage based on optional customer id. If the customer id is not set, returns current tenant API usage. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for entities that are related to the provided root entity. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for assets that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for devices that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for entity views that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data for edges that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqGuide() and getKeyFiltersGuide().")
    ...
    // Entity Count Query:
    @Tool(description = "Find Entity Data count of single entity by its id. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entities of the same type using the entity group type and id. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entities of the same type using their ids. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entities of the same type using the **'starts with'** expression over entity name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entities based on their type (CUSTOMER, USER, DASHBOARD, ASSET, DEVICE, etc). Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @PeOnly
    @Tool(description = "Find Entity Data count of multiple groups of the same type using specified ids. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @PeOnly
    @Tool(description = "Find Entity Data count of entity groups based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide()." + PE_ONLY_AVAILABLE)
    ...
    @PeOnly
    @Tool(description = "Find Entity Data count of entities that belong to group based on the entity type and the group name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide()." + PE_ONLY_AVAILABLE)
    ...
    @Tool(description = "Find Entity Data count of owner (Tenant or Customer) of the specified entity. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of assets based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of devices based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of edges based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entity views based on their type and the **'starts with'** expression over their name. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of api usage based on optional customer id. If the customer id is not set, returns current tenant API usage. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entities that are related to the provided root entity. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of assets that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of devices that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of entity views that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
    ...
    @Tool(description = "Find Entity Data count of edges that are related to the provided root entity. Filters related assets based on the relation type and set of asset types. Tip: for structure & examples, call getEdqCountGuide() and getKeyFiltersGuide().")
